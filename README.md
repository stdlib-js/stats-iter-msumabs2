...
```javascript
import itermsumabs2 from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-iter-msumabs2@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-iter-msumabs2/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/stats-iter-msumabs2/actions/workflows/test.yml?query=branch:v0.2.3
