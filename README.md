...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-iter-msumabs2/tags). For example,

```javascript
itermsumabs2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-iter-msumabs2@v0.2.2-umd/browser.js' )
```
